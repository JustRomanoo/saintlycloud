...
exports.oauthRouter.post('/oauth/store', async (req, res) => {
    try {
        ...
        await (0, db_js_1.storeOAuthToken)(normalizedCloudId, accessToken, username);
...
exports.oauthRouter.get('/oauth/token', async (req, res) => {
    try {
        ...
        const token = await (0, db_js_1.getOAuthToken)(cloudId);
        if (!token)
...
exports.oauthRouter.post('/oauth/init', async (req, res) => {
    try {
...
exports.oauthRouter.post('/oauth/complete', async (req, res) => {
    try {
        ...
        await (0, db_js_1.storeOAuthToken)(cloudId, accessToken, username);
...
exports.oauthRouter.post('/oauth/sync', async (req, res) => {
    try {
        ...
        const token = await (0, db_js_1.getOAuthToken)(normalizedCloudId);
        if (!token) {
    ...
    `;
        ...
        await (0, db_js_1.pushData)(normalizedCloudId, { bookmarks });
